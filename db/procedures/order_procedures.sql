      ...
      COALESCE(
        (SELECT jsonb_agg(
          jsonb_build_object(
            ...
            'catalogue_product_id', oi.catalogue_product_id,
            'catalogue_variant_id', oi.catalogue_variant_id,
            'product_media_id', oi.product_media_id,
            'product_handle', oi.product_handle,
            'sku', oi.sku,
            'title', oi.title,
