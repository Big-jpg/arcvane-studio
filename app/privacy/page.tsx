        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <div className="space-y-8 text-sm leading-relaxed text-charcoal/70">
            ...
            <div>
              ...
              <p className="mt-3">
                This keeps checkout simple across phones, tablets, shared devices, and work
                computers where social login may be unavailable or inappropriate. It also reduces
                the amount of identity data handled by the store. If you can receive email, you can
                access your order, confirm collection details, and provide any required fitting or
            ...
            <div>
              ...
              <p className="mt-3">
                When you place an order or make an enquiry, we may collect your name, email address,
                phone number if provided, order details, fitting selection, collection notes,
                shipping details where applicable, and any customisation information you choose to
                provide.
              </p>
              <p className="mt-3">
            ...
            <div>
              ...
              <p className="mt-3">
                Your information is used to process your order, prepare your shade, confirm fitting
                requirements, arrange local collection or shipping where available, provide order
                updates, respond to enquiries, and meet basic accounting and record-keeping
                obligations.
              </p>
              <p className="mt-3">
                We do not sell, rent, or trade customer information. We do not use customer accounts
                as a data-harvesting mechanism. The purpose of the store is to sell well-made
                lighting objects to people who want to purchase them, not to accumulate unnecessary
                customer profiles.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-3">
                If shipping becomes available for your order or location, the required delivery
                information will be collected only when needed for that fulfilment purpose.
              </p>
            </div>

            <div>
              <h2 className="text-lg font-semibold text-charcoal">Cookies and sessions</h2>
              <p className="mt-3">
                This site may use essential cookies or session storage for cart functionality,
                checkout continuity, authentication, and basic site operation. These are used so the
            ...
            <div>
              ...
              <p className="mt-3">
                ...
                prevention, and legal compliance purposes. Enquiry information is retained only for
                as long as reasonably required to respond and provide support.
              </p>
              <p className="mt-3">
            ...
            <p className="border-t border-charcoal/10 pt-6 text-xs leading-relaxed text-charcoal/40">
              This privacy policy should be reviewed before accepting live payments. It is written
              to describe the intended operating model of the store and may need adjustment for
              final legal, tax, payment, and fulfilment requirements.
            </p>
          </div>
        </div>
      </section>
