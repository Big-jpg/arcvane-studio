        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <div className="space-y-8 text-sm leading-relaxed text-charcoal/70">
            ...
            <div>
              ...
              <p className="mt-3">
                Because each item is produced individually, slight variations are an expected part
                of the process and contribute to the unique nature of the finished work.
              </p>
            </div>

            <div>
              <h2 className="text-lg font-semibold text-charcoal">Orders and production</h2>

              <p className="mt-3">
                Most products are prepared after an order is placed rather than held as warehouse
                inventory. Estimated lead times are provided as guidance only and may vary depending
                on studio workload, design complexity, material availability, and customisation
                requirements.
              </p>

              <p className="mt-3">
                Production of custom-developed or personalised works may begin shortly after order
                confirmation. Once production has materially commenced, cancellation or refund
            ...
            <div>
              ...
              <p className="mt-3">
                Every standard shade includes one fitting adapter compatible with either B22, E27,
                or Clipsal No. 530 fittings. Customers are responsible for selecting the most
                appropriate option during checkout.
              </p>

              <p className="mt-3">
                Where “Other / not sure” is selected, production may be paused until fitting
                compatibility is confirmed through photographs or additional information supplied by
                the customer.
              </p>
            ...
            <div>
              ...
              <p className="mt-3">
                Customers are responsible for ensuring collection details and contact information
                remain accurate. Orders not collected within a reasonable timeframe after repeated
                contact attempts may be cancelled or disposed of at the studio’s discretion.
              </p>

              <p className="mt-3">
                If shipping is offered in future, additional delivery terms may apply depending on
                destination, carrier availability, and product size.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-3">
                Due to the made-to-order nature of the studio, returns are generally accepted only
                where a product is materially defective, damaged prior to collection, or
                substantially inconsistent with the listed description.
              </p>
              ...
              <p className="mt-3">
                Refunds or replacements are assessed on a case-by-case basis with consideration
                given to the custom nature of the work.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-3">
                The supplied fitting adapters are mechanical support components only and do not
                alter electrical wiring or certified electrical infrastructure.
              </p>

              <p className="mt-3">
                Any electrical modifications should be performed by a qualified electrician in
                accordance with local regulations and Australian standards where applicable.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-3">
                Customers are responsible for maintaining access to the email address associated
                with their order. Access to order history, collection information, and future
                correspondence may depend on control of that email account.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-3">
                Nothing in these terms excludes rights or guarantees that cannot be excluded under
                Australian Consumer Law.
              </p>
            </div>

            <p className="border-t border-charcoal/10 pt-6 text-xs leading-relaxed text-charcoal/40">
              These terms describe the intended operating model of the studio and should be reviewed
              prior to accepting live commercial orders or enabling large-scale fulfilment.
            </p>
          </div>
        </div>
      </section>
